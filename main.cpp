...
int WINAPI WinMain(HINSTANCE h, HINSTANCE p, PSTR cmd, int show)
{
	...
	//USE FOR THE PLAYER TO CHANGE THE HEIGHT OF THE TERRAIN THERE IS STILL SOME BUGS WITH IT
	terrains = new terrain(dev,"Assets/heightmap.raw",64,64,10,0.5);//This Heightmap belongs to 
